...
public class XMLTest {
	...
	public void testLoad() throws IOException, URISyntaxException {
		...
		assertEquals(expected, XML.load(new File("src/test/resources/net/arnx/xmlic/test_ns.xml")).toString());
		assertEquals(expected, XML.load(new File("src/test/resources/net/arnx/xmlic/test_ns.xml").toURI()).toString());
