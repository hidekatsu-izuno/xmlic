...
public class XPathTest {
	...
	public void testXmlicXPath() throws Exception {
		...
		assertEquals(new XmlicXPath(xcontext, "descendant-or-self::node()/parent::a", false).toString(), new XmlicXPath(xcontext, "parent::a", true).toString());
		assertEquals(new XmlicXPath(xcontext, "descendant-or-self::a", false).toString(), new XmlicXPath(xcontext, "descendant-or-self::a", true).toString());
