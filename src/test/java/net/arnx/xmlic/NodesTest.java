...
public class NodesTest {
	...
	public void testAdd() throws IOException {
		XML xml = XML.load(getClass().getResource("test.xml"));
		assertEquals("<li>t1</li><li>t2</li><li>t4</li><li>t5</li><li>t7</li><li>t8</li>", xml.find("li[position()=2]").add("li[position()=1]").toString());
	}
	...
	public void testData() throws IOException {
		XML xml = XML.load(getClass().getResource("test.xml"));
		xml.find("li").data("name", "value").each(new Visitor<Nodes>() {
			@Override
			public void visit(Nodes current, Status status) {
				assertEquals("value", current.data("name"));
			}
		});
		xml.find("li").each(new Visitor<Nodes>() {
			@Override
			public void visit(Nodes current, Status status) {
				assertEquals("value", current.data("name"));
				current.removeData("name");
			}
		}).each(new Visitor<Nodes>() {
			@Override
			public void visit(Nodes current, Status status) {
				assertNull(current.data("name"));
			}
		});
	}
	...
	public void testFind() throws IOException {
		...
		assertEquals("<ul class=\"s12\">\n\t\t<li>t4</li>\n\t\t<li>t5</li>\n\t\t<li>t6</li>\n\t</ul>", xml.find("//li[position()=1]").find("../../ul[position()=2]").toString());
	...
	public void testInsertBefore() throws IOException {
		XML xml = XML.load(getClass().getResource("test.xml"));
		assertEquals("<li>t1</li><li>t4</li><li>t7</li>", xml.find("//li[position()=1]").insertBefore("ul[position()=1]").toString());
		assertEquals("<body>\ntop\n<div class=\"s1\">\n\t<li>t1</li><li>t4</li><li>t7</li><ul class=\"s11\">\n\t\t\n\t\t<li>t2</li>\n\t\t<li>t3</li>\n\t</ul>\n\t<ul class=\"s12\">\n\t\t\n\t\t<li>t5</li>\n\t\t<li>t6</li>\n\t</ul>\n</div>\nmiddle\n<div class=\"s2\">\n\tprefix\n\t<li>t1</li><li>t4</li><li>t7</li><ul class=\"s21\">\n\t\t\n\t\t<li>t8</li>\n\t\t<li>t9</li>\n\t</ul>\n\tsuffix\n</div>\nbottom\n</body>", xml.toString());
	}
	...
	public void testLocalName() throws IOException {
		...
		assertEquals("<body>\ntop\n<div class=\"s1\">\n\t<ul class=\"s11\">\n\t\t<span>t1</span>\n\t\t<li>t2</li>\n\t\t<li>t3</li>\n\t</ul>\n\t<ul class=\"s12\">\n\t\t<span>t4</span>\n\t\t<li>t5</li>\n\t\t<li>t6</li>\n\t</ul>\n</div>\nmiddle\n<div class=\"s2\">\n\tprefix\n\t<ul class=\"s21\">\n\t\t<span>t7</span>\n\t\t<li>t8</li>\n\t\t<li>t9</li>\n\t</ul>\n\tsuffix\n</div>\nbottom\n</body>", xml.find("//li[position()=1]").localName("span").owner().toString());
	}
	...
	public void testNormalize() throws IOException {
		...
		assertEquals("<body xmlns:svg=\"http://www.w3.org/2000/svg\">\ntop\n<div class=\"s1\">\n\t<ul class=\"s11\">\n\t\t<li>t1</li>\n\t\t<li>t2</li>\n\t\t<li>t3</li>\n\t</ul>\n\t<ul class=\"s12\">\n\t\t<li>t4</li>\n\t\t<li>t5</li>\n\t\t<li>t6</li>\n\t</ul>\n</div>\nmiddle\n<div class=\"s2\">\n\tprefix\n\t<ul svg:class=\"s21\">\n\t\t<li>t7</li>\n\t\t<li>t8</li>\n\t\t<li>t9</li>\n\t</ul>\n\tsuffix\n</div>\nbottom\n</body>", xml.find("//*").removeNamespace("http://www.w3.org/1999/xhtml").owner().normalize().toString());
	}
	...
	public void testPrefix() throws IOException {
		...
		assertEquals("<body>\ntop\n<div class=\"s1\">\n\t<ul class=\"s11\">\n\t\t<html:li>t1</html:li>\n\t\t<li>t2</li>\n\t\t<li>t3</li>\n\t</ul>\n\t<ul class=\"s12\">\n\t\t<html:li>t4</html:li>\n\t\t<li>t5</li>\n\t\t<li>t6</li>\n\t</ul>\n</div>\nmiddle\n<div class=\"s2\">\n\tprefix\n\t<ul class=\"s21\">\n\t\t<html:li>t7</html:li>\n\t\t<li>t8</li>\n\t\t<li>t9</li>\n\t</ul>\n\tsuffix\n</div>\nbottom\n</body>", xml.find("//li[position()=1]").prefix("html").owner().toString());
	}
	...
	public void testVal() throws IOException {
		...
		assertEquals("<body>\ntop\n<div class=\"v1\">\n\t<ul class=\"v1\">\n\t\t<li>t1</li>\n\t\t<li>t2</li>\n\t\t<li>t3</li>\n\t</ul>\n\t<ul class=\"v1\">\n\t\t<li>t4</li>\n\t\t<li>t5</li>\n\t\t<li>t6</li>\n\t</ul>\n</div>\nmiddle\n<div class=\"v1\">\n\tprefix\n\t<ul class=\"v1\">\n\t\t<li>t7</li>\n\t\t<li>t8</li>\n\t\t<li>t9</li>\n\t</ul>\n\tsuffix\n</div>\nbottom\n</body>", xml.select("//@*").val("v1").owner().toString());
	}
